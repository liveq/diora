...
const RelatedServices: React.FC = () => {
  const allServices = [
    ...
    },
    {
      ...
      icon: '🏢',
      title: '아파트 실거래가',
      subtitle: '전국 아파트 매매 실거래가 조회',
      englishTitle: 'APARTMENT TRANSACTION PRICE VIEWER',
      description: '전국 아파트 실거래가를 지도에서 실시간으로 확인하는 부동산 정보 도구입니다. 국토교통부 공공데이터를 기반으로 지역별, 기간별 거래 정보를 시각화하여 제공합니다. VWorld 지도 위에 마커로 거래 위치를 표시하고, 가격, 면적, 층수 등 상세 정보를 확인할 수 있습니다. 현재 화면에 보이는 모든 지역을 일괄 검색하는 기능도 지원합니다.',
      features: [
        '🗺️ 지도 기반 시각화 (VWorld)',
        '🔍 지역별 검색 (시/도/구/동)',
        '📅 기간별 조회 (최근 12개월)',
      ...
      useCases: '부동산 시세 조회, 아파트 매매가 확인, 지역별 거래 현황, 투자 분석, 실거래가 비교, 부동산 시장 분석',
      url: 'https://apt.baal.co.kr'
    },
    {
      id: 'baal',
      title: '바알',
